...
var _pay = __webpack_require__(104);

var _pay2 = _interopRequireDefault(_pay);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_pay2.default.el = '#root';
new Vue(_pay2.default);
...
__vue_options__.__file = "/Users/sally/Documents/毕设/weexapp/src/views/pay.vue"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    ...
    methods: {
        ...
        payCourse: function payCourse() {
            var adminId1 = void 0;
            var url = _Global2.default.dataUrl + "/api/getJson/payCourse";
            storage.getItem("adminId", function (adminId) {
                adminId1 = adminId.data;
            });
            var openId = _util2.default.getUrlParam("openid");
            var studentNumber = _util2.default.getUrlParam("studentNumber");
            var schoolId = _util2.default.getUrlParam("schoolId");
            var data = {
                openId: openId,
                ...
                if (token !== '') {
                    _util2.default.sendRequestWithTokenAndId(url, token.data, adminId1, data, function (ret) {
                        if (ret.data.objResult != null) {
                            var link = ret.data.objResult.data;
                            setTimeout(function () {
        ...
        openWindows: function openWindows(data) {
            console.log("!234");
            var dwSafari = void 0;
        ...
        open: function open(data) {
            var winOpen = window.open("", "_blank"); //首先打开一个新页面
            var link = data;
            setTimeout(function () {
                //这里使用setTimeout非常重要，没有将无法实现
                //原因是window.open会中断正在执行的进程，这样能保证其它代码执行完成再执行这个。
