...
__vue_options__.__file = "/Users/sally/Documents/毕设/weexapp/src/components/basic/shadow.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-4d1f6db1"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _bmyz = __webpack_require__(79);

var _bmyz2 = _interopRequireDefault(_bmyz);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_bmyz2.default.el = '#root';
new Vue(_bmyz2.default);
...
__vue_options__.__file = "/Users/sally/Documents/毕设/weexapp/src/views/bmyz.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-897d6474"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
module.exports = {
  ...
  "sub": {
    "height": 25 * CSS_UNIT.PT,
    "width": 180 * CSS_UNIT.PT,
    "backgroundColor": "#5987FF",
    "borderRadius": "50",
    "flexDirection": "row",
    "alignItems": "center",
  ...
  "look": {
    "width": "200",
    "height": "44",
    "borderColor": "rgba(255,110,44,1)",
    "backgroundColor": "rgba(255,110,44,1)",
    "borderRadius": "22",
    "flexDirection": "row",
    "alignItems": "center",
    "justifyContent": "center",
...
var modal = weex.requireModule('modal');
var stream = weex.requireModule('stream');
var tool = weex.requireModule('tools');
var bus = weex.requireModule('bus');
var storage = weex.requireModule('storage');
exports.default = {
    name: "bmyz",
    data: function data() {
    ...
    methods: {
        ...
        getParentsInfo: function getParentsInfo() {
            ...
            this.isLoading = true;
            var go = setTimeout(function () {
                var url = _Global2.default.dataUrl + '/api/getJson/getParentsInfo';
                var adminId1 = void 0;
                storage.getItem("adminId", function (adminId) {
                    adminId1 = adminId.data;
                });
                var data = { "studentId": adminId1 };
                    ...
                    if (token !== '') {
                        _util2.default.sendRequestWithTokenAndId(url, token.data, adminId1, data, function (ret) {
                            if (ret.data == null) {
                                ...
                                var selection = ret.data.selectionState;
                                _this2.fatherName = ret.data.dadName;
                                _this2.fatherWork = ret.data.dadWorkplace;
                                _this2.mumName = ret.data.mumName;
                                _this2.mumWork = ret.data.mumWorkplace;
                                _this2.reason = ret.data.reason;
                                _this2.userName = ret.data.studentName;
                                _this2.className = ret.data.className;
                                if (selection === 7) {
                                    _this2.gotoZXBM();
                                } else {
                                    if (selection === 2 || selection === 3) {
                                        _this2.shenqing = "您的服务申请未通过审核，请联系班主任，谢谢。";
                                        clearTimeout(go);
                                        _this2.check();
                                    } else {
                                        if (selection === 5 || selection === 6) {
                                            _this2.shenqing = "您的服务申请未通过审核，请联系学校管理员，谢谢。";
                                            _this2.butName = "审核未通过";
                                            clearTimeout(go);
                                            _this2.check();
                                        } else {
                                            if (selection == null) {
                                                ...
                                                _this2.shenqing = "您的申请已经递交，请耐心等待审核。";
                                                clearTimeout(go);
                                                _this2.check();
                                            }
                                        }
        ...
        getFormInfo: function getFormInfo() {
            ...
            this.isLoading = true;
            var go = setTimeout(function () {
                _this3.maskShow = !_this3.maskShow;
                clearTimeout(go);
                _this3.isLoading = false;
            }, 1500);
        },
        addParentsInfo: function addParentsInfo() {
            var _this4 = this;

            this.isLoading = true;
            var go = setTimeout(function () {
                var url = _Global2.default.dataUrl + '/api/getJson/addParentsInfo';
                var adminId1 = void 0;
                storage.getItem("adminId", function (adminId) {
                    adminId1 = adminId.data;
                });
                var data = {
                    "studentId": adminId1,
                    "dadName": _this4.fatherName,
                    "dadWorkplace": _this4.fatherWork,
                    "mumName": _this4.mumName,
                    "mumWorkplace": _this4.mumWork,
                    "reason": _this4.reason
                };
                if (_this4.fatherName == null || _this4.fatherWork == null || _this4.mumName == null || _this4.mumWork == null || _this4.reason == null || _this4.fatherName == "" || _this4.fatherWork == "" || _this4.mumName == "" || _this4.mumWork == "" || _this4.reason == "") {
                    clearTimeout(go);
                            ...
                            _util2.default.sendRequestWithTokenAndId(url, token.data, adminId1, data, function (ret) {
                                if (ret.data == null) {
                                    ...
                                    if (ret.data == true) {
                                        ...
                                        _this4.shenqing = "您的申请已经递交，请耐心等待审核。";
                                        clearTimeout(go);
                                        _this4.isLoading = false;
                                        _this4.getFormInfo();
                                    } else {
                                        if (ret.data == false) {
                                            _this4.shenqing = "您的申请未正常提交,请联系管理人员！";
                                            clearTimeout(go);
                                            _this4.isLoading = false;
                                            _this4.getFormInfo();
                                        }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("托管服务流程说明")]), _c('div', {
    staticClass: ["lines"]
  })]), _c('div', {
    staticClass: ["look"]
  }, [_c('text', {
    staticClass: ["lookText"]
  }, [_vm._v("点击查看")])])]), _c('div', {
    staticClass: ["baomingBox"]
  }, [_c('div', {
    staticClass: ["bossHead"]
  }, [_c('div', {
    staticClass: ["imgDian1"]
  }), _c('div', {
    staticClass: ["imgDian2"]
  }), _c('text', {
    staticClass: ["textBoss"]
  }, [_vm._v("校内托管申请表")]), _c('div', {
    staticClass: ["imgDian2"]
  }), _c('div', {
    staticClass: ["imgDian1"]
  })]), _c('div', {
    staticClass: ["topMesBox"]
  }, [_c('div', {
    staticClass: ["nameBox"]
  }, [_c('text', {
    staticClass: ["nameText"]
  }, [_vm._v("学生姓名")]), _c('input', {
    staticClass: ["textMsgB"],
    attrs: {
      "type": "text",
      "readonly": "flag=true",
      "value": (_vm.userName)
    ...
    on: {
      "input": function($event) {
        _vm.className = $event.target.attr.value
      }
    }
  }), _c('text', {
    staticClass: ["nameText"]
    ...
    staticClass: ["nameText"]
  }, [_vm._v("父亲姓名")]), _c('input', {
    staticClass: ["textMsg"],
    attrs: {
      "type": "text",
      "placeholder": "请输入",
      "readonly": _vm.flag == true ? true : false,
      "value": (_vm.fatherName)
    },
    on: {
      "input": function($event) {
        _vm.fatherName = $event.target.attr.value
      }
    }
  })]), _c('div', {
    staticClass: ["nameBox"]
    ...
    staticClass: ["nameText"]
  }, [_vm._v("工作单位")]), _c('input', {
    staticClass: ["textMsg"],
    attrs: {
      "type": "text",
      "placeholder": "请输入",
      "readonly": _vm.flag == true ? true : false,
      "value": (_vm.fatherWork)
    },
    on: {
      "input": function($event) {
        _vm.fatherWork = $event.target.attr.value
      }
    }
  })])]), _c('div', {
    staticClass: ["messageBox"]
    ...
    on: {
      "input": function($event) {
        _vm.mumName = $event.target.attr.value
      }
    }
  })]), _c('div', {
    staticClass: ["nameBox"]
    ...
    on: {
      "input": function($event) {
        _vm.mumWork = $event.target.attr.value
      }
    }
  })])]), _c('div', {
    staticClass: ["messageBox"]
  }, [_c('div', {
    staticClass: ["nameBox1"]
  }, [_c('text', {
    staticClass: ["nameText1"]
  }, [_vm._v("申请理由")]), _c('textarea', {
    staticClass: ["textMsg1"],
    attrs: {
      "type": "text",
      "placeholder": "请输入",
      "readonly": _vm.flag == true ? true : false,
    ...
    on: {
      "input": function($event) {
        _vm.reason = $event.target.attr.value
      }
    }
  })])]), (_vm.click) ? _c('div', {
    staticClass: ["sub"]
  ...
  }, [_vm._v(_vm._s(_vm.butName))])])])]) : _vm._e()]), (_vm.maskShow) ? _c('shadows', [_c('div', {
    staticClass: ["slot"]
  }, [_c('text', {
    staticClass: ["blockMessage"]
  }, [_vm._v(_vm._s(_vm.shenqing))]), _c('text', {
    staticClass: ["close"],
    on: {
      "click": _vm.closeShow
    }
  }, [_vm._v("关闭")])])]) : _vm._e(), (_vm.isLoading) ? _c('loading', {
    staticClass: ["load"]
  }) : _vm._e()], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
