...
var _denglu = __webpack_require__(85);

var _denglu2 = _interopRequireDefault(_denglu);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_denglu2.default.el = '#root';
new Vue(_denglu2.default);
...
__vue_options__.__file = "/Users/sally/Documents/毕设/weexapp/src/views/denglu.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-3c6f721d"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    ...
    data: function data() {
        return {
            marginTop: null,
            loading: false,
            loginImg: _Global2.default.imgUrl + '/login_bg%403x.png',
            middleImg: _Global2.default.imgUrl + '/sr_bg.png',
            titleImg: _Global2.default.imgUrl + '/titleLogin.png',
            bacImgHeight: '',
            loginName: '',
            password: '',
            isLoading: false
    ...
    methods: {
        ...
        login: function login() {
            ...
            var url = _Global2.default.dataUrl + '/api/getJson/studentLogin';
            var data = {
            ...
            if (this.loginName == null || this.password == null || this.loginName === "" || this.password === "") {
                ...
                _util2.default.sendRequest(url, data, function (ret) {
                    if (ret.data == null) {
                        _this4.loading = true;
                        ...
                        if (ret.data.result === "0") {
                            _this4.gotoBMYZ(ret.data.userName, ret.data.className);
                        } else {
        ...
        gotoBMYZ: function gotoBMYZ(userName, className) {
            var _this5 = this;

            this.isLoading = true;
            var go = setTimeout(function () {
                navigator.push({
                    url: _Global2.default.dicUrl + '/views/bmyz.html?userName=' + userName + "&className=" + className,
                    animated: "true"
                }, function (event) {
                    clearTimeout(go);
        ...
        getStudent1: function getStudent1() {
            var _this6 = this;

            var url = _Global2.default.dataUrl + '/api/getJson/getJson';
            var code = _util2.default.getUrlParam("code");
            var state = _util2.default.getUrlParam("state");
            var tokenInfo = _util2.default.getUrlParam("tokenInfo");
            if (code != null && code.length > 10 || tokenInfo != null && tokenInfo.length > 8) {
                var data = { "code": code, "state": state, "tokenInfo": tokenInfo };
                _util2.default.sendRequest(url, data, function (ret) {
                    if (ret.data == null) {
                        _this6.loading = true;
                        ...
                        storage.setItem('roleId', ret.data.roleId);
                        if (ret.data.result === "0") {
                            _this6.gotoBMYZ(ret.data.userName, ret.data.className);
                        } else {
                            if (ret.data.result === "1") {
                                _this6.gotoZXBM();
                            } else {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["load"]
  }) : _vm._e(), (_vm.loading) ? _c('div', [_c('div', {
    staticClass: ["nav"],
    style: {
    ...
    on: {
      "input": function($event) {
        _vm.loginName = $event.target.attr.value
      }
    }
  })]), _c('div', {
    staticClass: ["phone"]
