...
var _wdxx = __webpack_require__(107);

var _wdxx2 = _interopRequireDefault(_wdxx);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_wdxx2.default.el = '#root';
new Vue(_wdxx2.default);
...
__vue_options__.__file = "/Users/sally/Documents/毕设/weexapp/src/views/wdxx.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-62d0df27"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    ...
    data: function data() {
        return {
            ...
            xiaoxiImg: _Global2.default.imgUrl + '/tab_d_normal_icon%20copy.png',
    ...
    methods: {
        goTo: function goTo(url) {
            navigator.push({
                url: _Global2.default.dicUrl + '/views/' + url + '.html',
                animated: "true"
            }, function (event) {});
        },
        getTime: function getTime(date) {
        ...
        getMessages: function getMessages() {
            ...
            var url = _Global2.default.dataUrl + '/api/getMessages/getMessages';
            var adminId1 = void 0;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return (_vm.loading) ? _c('div', {
    ...
    return _c('div', {
      ...
      staticClass: ["personHead"],
      attrs: {
        "src": item.userHeader
      }
    }), _c('div', {
      staticClass: ["nameMsgBox"]
    }, [_c('text', {
      staticClass: ["name"]
      ...
      staticClass: ["clock"]
    }, [_vm._v(_vm._s(_vm.getTime(item.gmtCreate)))]), (item.readerNum != '0') ? _c('div', {
      staticClass: ["msgCountBox"]
    }, [_c('text', {
      staticClass: ["msgCount"]
    }, [_vm._v(_vm._s(item.readerNum))])]) : _vm._e()])])
  })), _c('text', {
    staticClass: ["noMsg"]
  }, [_vm._v("当前没有更多消息了")]), _c('div', {
    staticClass: ["footer"]
  }, [_c('div', {
    staticClass: ["icon"],
    on: {
