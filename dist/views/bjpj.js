...
var _bjpj = __webpack_require__(68);

var _bjpj2 = _interopRequireDefault(_bjpj);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_bjpj2.default.el = '#root';
new Vue(_bjpj2.default);
...
__vue_options__.__file = "/Users/sally/Documents/毕设/weexapp/src/views/bjpj.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-0c51865c"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    ...
    data: function data() {
        return {
            ...
            courseName: '',
            teacherId: '',
            Img: _Global2.default.imgUrl + '/QQ%E5%9B%BE%E7%89%8720190825183144.jpg',
            isLoading: false,
            textName: '班级评价',
            titleUrl: 'zxbm.html',
            scrollHeight: '',
            heagerImg: _Global2.default.imgUrl + '/QQ%E5%9B%BE%E7%89%8720190825183144.jpg',
            fengcaiImg: _Global2.default.imgUrl + '/tab_b_normal_icon%402x.png',
            pingjiaImg: _Global2.default.imgUrl + '/tab_c_active_icon%402x.png',
            xiaoxiImg: _Global2.default.imgUrl + '/tab_d_normal_icon.png',
            baomingImg: _Global2.default.imgUrl + '/rectangular.png',
            shineStar: _Global2.default.imgUrl + '/star2.png',
            blackStar: _Global2.default.imgUrl + '/star1.png',
            courseNum: '5',
            teaNum: '5',
            bothNum: '5',
            middleHeight: '',
    ...
    methods: {
        changeCourse: function changeCourse(i) {
            this.courseNum = i;
        },
        changebothNum: function changebothNum(i) {
            this.bothNum = i;
        },
        changeteaNum: function changeteaNum(i) {
            this.teaNum = i;
        },
        ...
        gotoBJFC: function gotoBJFC() {
            var _this2 = this;

            this.isLoading = true;
            var go = setTimeout(function () {
                navigator.push({
                    url: _Global2.default.dicUrl + '/views/bjfc.html',
                    animated: "true"
                }, function (event) {
                    clearTimeout(go);
        ...
        getAppraise: function getAppraise() {
            var _this3 = this;

            this.isLoading = true;
            var go = setTimeout(function () {
                var url = _Global2.default.dataUrl + '/api/getAppraise/getAppraiseInfo';
                var adminId1 = void 0;
                ...
                storage.getItem("token", function (token) {
                    if (token != '') {
                        _util2.default.sendRequestWithTokenAndId(url, token.data, adminId1, data, function (ret) {
                            if (ret.data != null) {
                                _this3.courseId = ret.data.courseId;
                                _this3.courseName = ret.data.courseName;
                                _this3.courseNum = ret.data.courseAppraise;
                                _this3.teaNum = ret.data.teacherAppraise;
                                _this3.bothNum = ret.data.resultAppraise;
                                _this3.teacherId = ret.data.teacherId;
                                _this3.otherReason = ret.data.otherAppraise;
                                clearTimeout(go);
        ...
        addAppraise: function addAppraise() {
            var _this4 = this;

            var url = _Global2.default.dataUrl + '/api/getAppraise/addAppraise';
            var adminId1 = void 0;
            var schoolId1 = void 0;
            var go = setTimeout(function () {
                storage.getItem("adminId", function (adminId) {
                ...
                var data = {
                    "studentId": adminId1,
                    "schoolId": schoolId1,
                    "courseAppraise": _this4.courseNum,
                    "teacherAppraise": _this4.teaNum,
                    "resultAppraise": _this4.bothNum,
                    "otherAppraise": _this4.otherReason,
                    "courseId": _this4.courseId,
                    "teacherId": _this4.teacherId,
                    "courseName": _this4.courseName
                };
                storage.getItem("token", function (token) {
                    if (token !== '') {
    ...
    created: function created() {
        this.middleHeight = _computed2.default.env.getPageHeight() - 270 + 'px';
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["scoreText"]
  }, [_vm._v("请对您所在班级进行评分")]), _c('text', {
    staticClass: ["state"]
  }, [_vm._v("课程内容情况")]), _c('div', {
    staticClass: ["star"]
  }, [_c('div', {
    staticClass: ["starNum"]
  ...
  })), (_vm.courseNum < 3 && _vm.courseNum > 0) ? _c('text', {
    staticClass: ["evaluate1"]
  }, [_vm._v("较差")]) : _vm._e(), (_vm.courseNum === 3) ? _c('text', {
    staticClass: ["evaluate1"]
  }, [_vm._v("一般")]) : _vm._e(), (_vm.courseNum > 3) ? _c('text', {
    staticClass: ["evaluate1"]
  }, [_vm._v("较好")]) : _vm._e(), (_vm.courseNum === 0) ? _c('text', {
    staticClass: ["evaluate"]
  }, [_vm._v("请评价")]) : _vm._e()]), _c('text', {
    staticClass: ["state"]
  }, [_vm._v("老师负责情况")]), _c('div', {
    staticClass: ["star"]
  }, [_c('div', {
    staticClass: ["starNum"]
  }, _vm._l((5), function(index) {
  ...
  })), (_vm.teaNum < 3 && _vm.teaNum > 0) ? _c('text', {
    staticClass: ["evaluate1"]
  }, [_vm._v("较差")]) : _vm._e(), (_vm.teaNum === 3) ? _c('text', {
    staticClass: ["evaluate1"]
  }, [_vm._v("一般")]) : _vm._e(), (_vm.teaNum > 3) ? _c('text', {
    staticClass: ["evaluate1"]
  }, [_vm._v("较好")]) : _vm._e(), (_vm.teaNum === 0) ? _c('text', {
    staticClass: ["evaluate"]
  }, [_vm._v("请评价")]) : _vm._e()]), _c('text', {
    staticClass: ["state"]
  }, [_vm._v("整体评价情况")]), _c('div', {
    staticClass: ["star"]
  }, [_c('div', {
    staticClass: ["starNum"]
  }, _vm._l((5), function(index) {
  ...
  })), (_vm.bothNum < 3 && _vm.bothNum > 0) ? _c('text', {
    staticClass: ["evaluate1"]
  }, [_vm._v("较差")]) : _vm._e(), (_vm.bothNum === 3) ? _c('text', {
    staticClass: ["evaluate1"]
  }, [_vm._v("一般")]) : _vm._e(), (_vm.bothNum > 3) ? _c('text', {
    staticClass: ["evaluate1"]
  }, [_vm._v("较好")]) : _vm._e(), (_vm.bothNum === 0) ? _c('text', {
    staticClass: ["evaluate"]
  }, [_vm._v("请评价")]) : _vm._e()]), _c('text', {
    staticClass: ["state"]
  }, [_vm._v("其他说明")]), _c('textarea', {
    staticClass: ["areaText"],
    attrs: {
      "rows": "10",
      "placeholder": "请输入其他说明",
    ...
    on: {
      "input": function($event) {
        _vm.otherReason = $event.target.attr.value
      }
    }
  }), _c('div', {
    staticClass: ["denglu"],
    on: {
      "click": _vm.addAppraise
    }
  }, [_c('text', {
    staticClass: ["dengluText"]
  }, [_vm._v("提交评价")])])]), _c('div', {
    staticClass: ["footer"]
  }, [_c('div', {
    staticClass: ["icon"],
