...
__vue_options__.__file = "/Users/sally/Documents/毕设/weexapp/src/components/basic/Navbar.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-17b6167e"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    ...
    components: {
        'global_': _Global2.default
    },
    created: function created() {
        if (_computed2.default.env.isIOS()) {
            this.marginTop = 30 + 'px';
        }
        if (_computed2.default.env.isIPhoneX()) {
...
var _bjfc = __webpack_require__(61);

var _bjfc2 = _interopRequireDefault(_bjfc);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_bjfc2.default.el = '#root';
new Vue(_bjfc2.default);
...
__vue_options__.__file = "/Users/sally/Documents/毕设/weexapp/src/views/bjfc.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-0a4328c2"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    ...
    data: function data() {
        return {
            ...
            reply: false,
            replyUser: true,
            dianzanIcon: _Global2.default.imgUrl + '/dz_w.png',
            dianzanIcon2: _Global2.default.imgUrl + '/dz_y.png',
            pinglunIcon: _Global2.default.imgUrl + '/pl.png',
            contentTitleImg: '',
            contentTitleName: '',
            courseId: '',
            adminId: '',
    ...
    methods: {
        ...
        emotion: function emotion(res) {
            ...
            var list = ['微笑', '撇嘴', '色', '发呆', '得意', '流泪', '害羞', '闭嘴', '睡', '大哭', '尴尬', '发怒', '调皮', '呲牙', '惊讶', '难过', '酷', '冷汗', '抓狂', '吐', '偷笑', '可爱', '白眼', '傲慢', '饥饿', '困', '惊恐', '流汗', '憨笑', '大兵', '奋斗', '咒骂', '疑问', '嘘', '晕', '折磨', '衰', '骷髅', '敲打', '再见', '擦汗', '抠鼻', '鼓掌', '糗大了', '坏笑', '左哼哼', '右哼哼', '哈欠', '鄙视', '委屈', '快哭了', '阴险', '亲亲', '吓', '可怜', '菜刀', '西瓜', '啤酒', '篮球', '乒乓', '咖啡', '饭', '猪头', '玫瑰', '凋谢', '示爱', '爱心', '心碎', '蛋糕', '闪电', '炸弹', '刀', '足球', '瓢虫', '便便', '月亮', '太阳', '礼物', '拥抱', '强', '弱', '握手', '胜利', '抱拳', '勾引', '拳头', '差劲', '爱你', '爱情', '飞吻', '跳跳', '发抖', '怄火', '转圈', '磕头', '回头', '跳绳', '挥手', '激动', '街舞', '献吻', '左太极', '右太极'];
            var index = list.indexOf(word);
            return '<img src="https://res.wx.qq.com/mpres/htmledition/images/icon/emotion/' + index + '.gif" align="middle">';
        },
        updateReply: function updateReply(userId, userName, momentsId) {
        ...
        gotoFBFC: function gotoFBFC() {
            ...
            var go = setTimeout(function () {
                navigator.push({
                    url: _Global2.default.dicUrl + '/views/fbfc.html?courseId=' + courseId,
                    animated: "true"
                }, function (event) {
                    clearTimeout(go);
        ...
        addPraise: function addPraise(zan, key, index) {
            var _this4 = this;

            if (zan === 0) {
                var url = _Global2.default.dataUrl + '/api/getMoments/addPraise';
                var adminId1 = void 0;
                    ...
                    if (token !== '') {
                        _util2.default.sendRequestWithTokenAndId(url, token.data, adminId1, data, function (ret) {
                            if (ret.data.longResult === 1) {
                                _this4.$set(_this4.fabuList[index], 'zan', 1);
                            } else {
                ...
                var _url = _Global2.default.dataUrl + '/api/getMoments/removePraise';
                var _adminId = void 0;
                storage.getItem("adminId", function (adminId) {
                    _adminId = adminId.data;
                });
                var _data = {
                    momentId: key,
                    adminId: _adminId
                ...
                storage.getItem("token", function (token) {
                    if (token !== '') {
                        _util2.default.sendRequestWithTokenAndId(_url, token.data, _adminId, _data, function (ret) {
                            if (ret.data.longResult === 1) {
                                _this4.$set(_this4.fabuList[index], 'zan', 0);
                            } else {
                                modal.toast({ message: "请检查网络，如无问题请联系管理员！", duration: 1.6 });
                            }
                        });
        ...
        removeMoment: function removeMoment(key) {
            var url = _Global2.default.dataUrl + '/api/getMoments/removeMoment';
            var adminId1 = void 0;
            storage.getItem("adminId", function (adminId) {
                adminId1 = adminId.data;
            });
            ...
            storage.getItem("token", function (token) {
                if (token !== '') {
                    _util2.default.sendRequestWithToken(url, token.data, adminId1, data, function (ret) {
                        if (ret.data.longResult === 0) {} else {
                            modal.toast({ message: "请检查网络，如无问题请联系管理员！", duration: 1.6 });
                        }
                    });
                } else {
        ...
        removeReplies: function removeReplies(key) {
            var url = _Global2.default.dataUrl + '/api/getMoments/removeReplies';
            var adminId1 = void 0;
            storage.getItem("adminId", function (adminId) {
                adminId1 = adminId.data;
            });
        ...
        addReplies: function addReplies(toUser, content, momentsId) {
            var url = _Global2.default.dataUrl + '/api/getMoments/addReplies';
            var adminId1 = void 0;
            storage.getItem("adminId", function (adminId) {
                adminId1 = adminId.data;
            });
            ...
            storage.getItem("token", function (token) {
                if (token !== '') {
                    _util2.default.sendRequestJson(url, token.data, adminId1, JSON.stringify(data), function (ret) {
                        if (ret.data.longResult === 0) {} else {
                            modal.toast({ message: "请检查网络，如无问题请联系管理员！", duration: 1.6 });
                        }
                    });
        ...
        getMoments: function getMoments() {
            ...
            var url = _Global2.default.dataUrl + '/api/getMoments/getMoments';
            var adminId1 = void 0;
            var roleId1 = void 0;
            storage.getItem("adminId", function (adminId) {
                adminId1 = adminId.data;
            ...
            storage.getItem("token", function (token) {
                if (token !== '') {
                    _util2.default.sendRequestJson(url, token.data, adminId1, JSON.stringify(data), function (ret) {
                        if (ret.data != null) {
                            _this5.fabuList = ret.data.list;
                            _this5.contentTitleName = ret.data.fetchList[0].courseName;
                            _this5.contentTitleImg = ret.data.fetchList[0].headerImg;
                            _this5.courseId = ret.data.fetchList[0].courseId;
                            var i = void 0;
                            for (i = 0; i < ret.data.list.length; i++) {
                                var info = JSON.parse(ret.data.list[i].images);
                                var len = info.length;
                                _this5.fabuList[i].images = [];
                                for (var a = 0; a < len; a++) {
                                    var type = info[a].replace("http://afterschool2019.oss-cn-hangzhou.aliyuncs.com/", "").split("/");
                                    if (type[0] === "video") {
                                        _this5.fabuList[i].images.splice(a, 0, { type: false, url: info[a] });
                                    } else {
                                        _this5.fabuList[i].images.splice(a, 0, { type: true, url: info[a] });
                                    }
                                }
                                var reply = parseInt(ret.data.list[i].list.length) * 40;
                                var praise = parseInt(ret.data.list[i].praises.length / 5 + 1) * 40;
                                _this5.fabuList[i].replyHeight = reply;
                                _this5.fabuList[i].praiseHeight = praise;
                                if (len <= 3) {
                                    _this5.fabuList[i].height = 350;
                                } else if (len >= 3 && len <= 6) {
                                    _this5.fabuList[i].height = 500;
                                } else {
                                    _this5.fabuList[i].height = 625;
                                }
                                _this5.fabuList[i].gmtCreate = _util2.default.getTime(ret.data.list[i].gmtCreate);
                            }
                            setTimeout(function () {
                                _this5.loading = true;
                            }, 100);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [(_vm.isLoading) ? _c('loading', {
    staticClass: ["load"]
  }) : _vm._e(), (_vm.reply) ? _c('div', {}, [_c('div', {
    staticClass: ["container"]
  }, [_c('p', [_vm._v("文本输入框")]), _c('textarea', {
    staticClass: ["text"],
    attrs: {
      "rows": "5",
      "value": (_vm.content)
  ...
  }), _c('p', [_vm._v("表情选择框")]), _c('emotion', {
    attrs: {
      "height": 200
    },
    on: {
      "emotion": _vm.handleEmotion
    }
  }), _c('p', [_vm._v("效果显示框")]), _c('div', {
    staticClass: ["text-place"]
  }, [_c('p', {
    directives: [{
      name: "html",
      rawName: "v-html",
      value: (_vm.content.replace(/\#[\u4E00-\u9FA5]{1,3}\;/gi, _vm.emotion)),
      expression: "content.replace(/\\#[\\u4E00-\\u9FA5]{1,3}\\;/gi, emotion)"
    }]
    ...
    staticClass: ["contentTitleImg"],
    attrs: {
      "src": _vm.contentTitleImg
    }
  }), _c('text', {
    staticClass: ["contentTitleName"]
  }, [_vm._v("#" + _vm._s(_vm.contentTitleName) + "#")]), _c('div', {
    staticClass: ["fabuBox"]
  }, [_c('text', {
    staticClass: ["fabu2"],
    on: {
  ...
  }, [_vm._v("发布风采")])])]), _vm._l((_vm.fabuList), function(item, index) {
    return _c('div', {
      key: item.key,
      staticClass: ["content"]
    }, [_c('div', {
      ...
      style: {
        height: item.height + item.replyHeight + item.praiseHeight
      },
      attrs: {
        "overflow:hidden": ""
      }
    }, [_c('image', {
      staticClass: ["peopleHead"],
      attrs: {
        "src": item.userHeader
      }
    }), _c('div', {
      staticClass: ["fabuContent"],
      style: {
        height: item.height - 200
      }
    }, [_c('text', {
      staticClass: ["fabuName"]
    }, [_vm._v(_vm._s(item.userName))]), _c('text', {
      staticClass: ["fabuText"]
    }, [_vm._v(_vm._s(item.content))]), _c('div', {
      staticClass: ["fabuImgBox"],
      style: {
        height: item.height - 200
      }
    }, [_c('div', {
    ...
    }, _vm._l((item.images), function(item1) {
      return _c('div', {
        staticClass: ["addBtn"]
      }, [(item1.type) ? _c('image', {
        staticClass: ["addBtnImg"],
        attrs: {
          "src": item1.url
        }
      }) : _c('video', {
      ...
      staticClass: ["contentFooter"]
    }, [_c('text', {
      staticClass: ["time"]
    }, [_vm._v(_vm._s(item.gmtCreate))]), (item.zan == 0) ? _c('image', {
      staticClass: ["dianzan"],
      attrs: {
        "src": _vm.dianzanIcon
      },
      on: {
        "click": function($event) {
          _vm.addPraise(item.zan, item.key, index)
        }
      }
    }) : _c('image', {
      staticClass: ["dianzan"],
      attrs: {
        "src": _vm.dianzanIcon2
      },
      on: {
        "click": function($event) {
          _vm.addPraise(item.zan, item.key, index)
      ...
      on: {
        "click": function($event) {
          _vm.updateReply(item.userId, item.userName, item.momentsId)
        }
      }
    }, [_vm._v("评论")])]), _c('div', {
      staticClass: ["repcomment"],
      style: {
        height: item.replyHeight + item.praiseHeight
      }
    }, [(item.replyHeight + item.praiseHeight > 0) ? _c('div', {
      staticClass: ["comments"]
    }, [_c('span', {
      staticClass: ["triangle"]
    }), (item.praises.length > 0) ? _c('div', {
      staticClass: ["top"]
    }, [(item.praises.length > 0) ? _c('div', {
      staticClass: ["like"],
      style: {
        height: item.praiseHeight
      }
    }, [_c('p', [_c('span', {
      staticClass: ["icon-heart-empty", "i-like"]
    }), _vm._l((item.praises), function(praise, index) {
      return _c('span', {
        key: index,
        staticClass: ["user"]
      }, [_vm._v("\n                                     " + _vm._s(praise.userName) + "\n                                     "), (index != item.praises.length - 1) ? _c('span', {
        staticClass: ["dh-black"]
      }, [_vm._v(",")]) : _vm._e()])
    })], 2)], 1) : _vm._e(), _c('div', {
      staticClass: ["comment"]
    }, _vm._l((item.list), function(reply, index) {
      return _c('div', {
        key: index,
        staticClass: ["com-space"]
      }, [(reply.toUser != null) ? _c('div', [_c('a', {
        staticClass: ["reply"],
        attrs: {
          "href": "javascript:;"
        },
        ...
        staticClass: ["user"]
      }, [_vm._v(_vm._s(reply.userName) + ":" + _vm._s(reply.content))])])]) : _c('div', _vm._l((item.list), function(reply, index) {
        return _c('a', {
          key: index,
          staticClass: ["com-space"]
        }, [_c('span', {
          staticClass: ["user"]
        }, [_vm._v(_vm._s(reply.userName) + "回复" + _vm._s(reply.toName) + ":" + _vm._s(reply.content))])])
      }))])
    }))]) : _vm._e()]) : _vm._e()])])])])
  })], 2) : _vm._e()])
},staticRenderFns: []}
