...
var _jieshou = __webpack_require__(101);

var _jieshou2 = _interopRequireDefault(_jieshou);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_jieshou2.default.el = '#root';
new Vue(_jieshou2.default);
...
__vue_options__.__file = "/Users/sally/Documents/毕设/weexapp/src/views/jieshou.vue"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    payInfo: function payInfo() {
      var url = _Global2.default.dataUrl + "/api/getJson/getPayInfo";
      var data = void 0;
      var info = decodeURI(weex.config.bundleUrl);
      var trade_no = _util2.default.getUrlParam("trade_no");
      var total_amount = _util2.default.getUrlParam("total_amount");
      var trade_status = _util2.default.getUrlParam("trade_status");
      data = {
        info: info,
        trade_no: trade_no,
