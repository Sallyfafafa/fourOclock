...
var _zxbm = __webpack_require__(117);

var _zxbm2 = _interopRequireDefault(_zxbm);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_zxbm2.default.el = '#root';
new Vue(_zxbm2.default);
...
__vue_options__.__file = "/Users/sally/Documents/毕设/weexapp/src/views/zxbm.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-d36932ba"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    ...
    data: function data() {
        return {
            ...
            pingjiaImg: _Global2.default.imgUrl + '/tab_c_active_icon%20copy.png',
            xiaoxiImg: _Global2.default.imgUrl + '/tab_d_normal_icon.png',
            baomingImg: _Global2.default.imgUrl + '/rectangular_copy.png',
            classImg: _Global2.default.imgUrl + '/class.png',
            isLoading: false,
            loading: false,
            Img: _Global2.default.imgUrl + '/QQ%E5%9B%BE%E7%89%8720190825183207.jpg',
            arrList: [{
                courseId: '',
                courseName: '',
                headerImg: '',
    ...
    created: function created() {
        this.getClass();
        this.scrollHeight = _computed2.default.env.getScreenHeight() - 360 + 'px';
    },

    components: { 'navbar': _Navbar2.default, 'loading': _loading2.default },
    methods: {
        gotoBJXQ: function gotoBJXQ(courseId) {
            var _this = this;

            this.isLoading = true;
            var go = setTimeout(function () {
                navigator.push({
                    url: _Global2.default.dicUrl + '/views/bjxq.html?courseId=' + courseId,
                    animated: "true"
                }, function (event) {
                    clearTimeout(go);
        ...
        selectionCourse: function selectionCourse(courseId, grade) {
            var _this6 = this;

            this.isLoading = true;
            this.clickOnce = false;
            var go = setTimeout(function () {
                var url = _Global2.default.dataUrl + '/api/getJson/addSelection';
                var adminId1 = void 0;
                ...
                var data = { studentId: adminId1, courseId: courseId, grade: grade, schoolId: schoolId1 };
        ...
        getClass: function getClass() {
            ...
            this.isLoading = true;
            var go = setTimeout(function () {
                var url = _Global2.default.dataUrl + '/api/getJson/getCourseInfo';
                var adminId1 = void 0;
                var schoolId1 = void 0;
                storage.getItem("adminId", function (adminId) {
                    adminId1 = adminId.data;
                ...
                var data = { adminId: adminId1, schoolId: schoolId1 };
                storage.getItem("token", function (token) {
                    if (token !== '') {
                        _util2.default.sendRequestWithTokenAndId(url, token.data, adminId1, data, function (ret) {
                            if (ret.data != null) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["classImg"],
    attrs: {
      "src": _vm.classImg
    }
  }), _c('text', {
    staticClass: ["classRoom"]
  }, [_vm._v("可选班级")])]), _c('scroller', {
    staticClass: ["scrollerCla"],
    style: {
    ...
    return _c('div', {
      ...
      staticClass: ["classRooms"]
    }, [_vm._v(_vm._s(item.courseName))]), _c('text', {
      staticClass: ["teacher"]
    }, [_vm._v("上课老师：" + _vm._s(item.teacherName))]), _c('text', {
      staticClass: ["direction"]
    }, [_vm._v("面向年级：" + _vm._s(item.grade))])]), (item.selectionState == null) ? _c('div', {
      staticClass: ["baomingDiv"]
    }, [(_vm.clickOnce) ? _c('text', {
      staticClass: ["baomingText"],
      staticStyle: {
        width: "50px"
      },
      on: {
        "click": function($event) {
          _vm.selectionCourse(item.courseId, item.grade)
        }
      }
    }, [_vm._v("报名")]) : _c('text', {
      staticClass: ["baomingText"],
    ...
    }, [_vm._v("报名")])]) : _vm._e(), (item.selectionState == 0) ? _c('div', {
      staticClass: ["zhuangtai"]
    }, [_c('text', {
      staticClass: ["baomingText"],
      staticStyle: {
        color: "#5987FF"
      }
    }, [_vm._v("待审核")])]) : _vm._e(), (item.selectionState == 1) ? _c('div', {
      staticClass: ["zhuangtai"]
    }, [_c('text', {
      staticClass: ["baomingText"],
      staticStyle: {
    ...
    }, [_vm._v("已通过")])]) : _vm._e(), (item.selectionState == 2) ? _c('div', {
      staticClass: ["zhuangtai"]
    }, [_c('text', {
      staticClass: ["baomingText"],
      staticStyle: {
    ...
    }, [_vm._v("未通过")])]) : _vm._e()]), _c('div', {
      staticClass: ["cardBot"]
    }, [_c('div', {
      staticClass: ["cardBotLeft"]
    }, [_c('text', {
      staticClass: ["num"]
    }, [_vm._v(_vm._s(item.courseCapacity))]), _c('text', {
      staticClass: ["direction"]
    }, [_vm._v("班级容量")])]), _c('div', {
      staticClass: ["cardBotLeft"]
    }, [_c('text', {
      staticClass: ["num"]
    }, [_vm._v(_vm._s(item.choseNum))]), _c('text', {
      staticClass: ["direction"]
    }, [_vm._v("已报名人数")])]), _c('div', {
      staticClass: ["cardBotLeft"]
    }, [_c('text', {
      staticClass: ["num"]
    }, [_vm._v(_vm._s(item.courseSelected))]), _c('text', {
      staticClass: ["direction"]
    }, [_vm._v("通过人数")])])])])
  }), _c('text', {
    staticClass: ["footer"]
  }, [_vm._v("当前没有更多课程了")])], 2), _c('div', {
    ...
    staticClass: ["bao"]
  }, [_vm._v("个人中心")])])])]) : _vm._e()]), (_vm.isLoading) ? _c('loading', {
    staticClass: ["load"]
  }) : _vm._e()], 1)
},staticRenderFns: []}
