...
var _zhuce = __webpack_require__(112);

var _zhuce2 = _interopRequireDefault(_zhuce);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_zhuce2.default.el = '#root';
new Vue(_zhuce2.default);
...
__vue_options__.__file = "/Users/sally/Documents/毕设/weexapp/src/views/zhuce.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-d80a3102"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    ...
    data: function data() {
        return {
            ...
            titleImg: _Global2.default.imgUrl + '/title@3x.png',
            bacImgHeight: '',
            textName: '用户注册',
    ...
    created: function created() {
        this.bacImgHeight = _computed2.default.env.getPageHeight() - 88 + 'px';
    },

    components: { 'navbar': _Navbar2.default },
    methods: {
        gotoDenglu: function gotoDenglu() {
            navigator.push({
