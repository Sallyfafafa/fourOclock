...
var _bjxq = __webpack_require__(73);

var _bjxq2 = _interopRequireDefault(_bjxq);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_bjxq2.default.el = '#root';
new Vue(_bjxq2.default);
...
__vue_options__.__file = "/Users/sally/Documents/毕设/weexapp/src/views/bjxq.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-1a5aefdb"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    ...
    created: function created() {
        ...
        this.scrollHeight = _computed2.default.env.getPageHeight() - 360 + 'px';
    },
    ...
    methods: {
        ...
        getOneCourseInfo: function getOneCourseInfo() {
            var _this2 = this;

            var go = setTimeout(function () {
                var courseId = _util2.default.getUrlParam("courseId");
                var url = _Global2.default.dataUrl + '/api/getJson/getOneCourseInfo';
                var adminId1 = void 0;
        ...
        selectionCourse: function selectionCourse(courseId, grade) {
            ...
            var go = setTimeout(function () {
                ...
                var data = { studentId: adminId1, courseId: courseId, grade: grade };
                storage.getItem("token", function (token) {
                    if (token !== '') {
                        _util2.default.sendRequestWithTokenAndId(url, token.data, adminId1, data, function (ret) {
                            if (ret.data == null) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "src": _vm.arrList.headerImg
    }
  }), _c('div', {
    staticClass: ["message"]
  }, [_c('text', {
    staticClass: ["classRooms"]
  }, [_vm._v(_vm._s(_vm.arrList.courseName))]), _c('text', {
    staticClass: ["teacher"]
  }, [_vm._v("上课老师：" + _vm._s(_vm.arrList.teacherName))]), _c('text', {
    staticClass: ["direction"]
  }, [_vm._v("面向年级：" + _vm._s(_vm.arrList.grade))])]), (_vm.arrList.selectionState == null) ? _c('div', {
    ...
    on: {
      "click": function($event) {
        _vm.selectionCourse(_vm.arrList.courseId, _vm.arrList.grade)
      }
    }
  }, [_vm._v("报名\n                    ")]) : _c('text', {
    staticClass: ["baomingText"],
  ...
  }, [_vm._v("报名\n                    ")])]) : _vm._e(), (_vm.arrList.selectionState == 0) ? _c('div', {
  ...
  }, [_vm._v("待审核")])]) : _vm._e(), (_vm.arrList.selectionState == 1) ? _c('div', {
    staticClass: ["zhuangtai"]
  }, [_c('text', {
    staticClass: ["baomingText"],
    staticStyle: {
  ...
  }, [_vm._v("已通过")])]) : _vm._e(), (_vm.arrList.selectionState == 2) ? _c('div', {
    staticClass: ["zhuangtai"]
  }, [_c('text', {
    staticClass: ["baomingText"],
    staticStyle: {
    ...
    staticClass: ["num"]
  }, [_vm._v(_vm._s(_vm.arrList.courseCapacity))]), _c('text', {
    staticClass: ["direction"],
    staticStyle: {
      color: "white"
    }
    ...
    staticClass: ["num"]
  }, [_vm._v(_vm._s(_vm.arrList.choseNum))]), _c('text', {
    staticClass: ["direction"],
    staticStyle: {
      color: "white"
    }
    ...
    staticClass: ["num"]
  }, [_vm._v(_vm._s(_vm.arrList.courseSelected))]), _c('text', {
    staticClass: ["direction"],
    staticStyle: {
      color: "white"
    }
  }, [_vm._v("通过人数")])])])]) : _vm._e(), (_vm.loading) ? _c('scroller', {
    key: "box1",
    staticClass: ["detail"],
    style: {
    ...
    staticClass: ["blockHea"]
  }), _c('text', {
    staticClass: ["detailTe"]
  }, [_vm._v("班级介绍")])]), _c('text', {
